...
//[c]: z then y
//You receive this output because the function sets y to display after a
//1 millisecond delay, during this delay the function continues on a displays
//z after which the 1 millisecond delay has expired and y is then displayed.
//Nothing is passed into the function so the declaration of var letter = "x";
//has no affect on the the output of the function (x is never displayed).
...
// Put your answer below -------------------------
//Speed is set to NaN when nothing is passed to the function because you can't
//add no value to speed.  If nothing is passed to amount, it is undefined and
//when "undefined" is added to speed NaN is the result.
var speed = 0;
